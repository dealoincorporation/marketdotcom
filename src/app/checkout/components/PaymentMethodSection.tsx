  ...
  return (
    <div className="bg-white/85 backdrop-blur-3xl rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-white/70 overflow-hidden w-full transition-all duration-500">
      ...
      <div className="bg-gray-900 p-8 sm:p-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-2">
            ...
            <h2 className="text-sm font-black text-white uppercase tracking-[0.4em]">Payment Method</h2>
          </div>
      ...
      <div className="p-8 sm:p-10">
        <RadioGroup value={paymentMethod} onValueChange={onPaymentMethodChange} className="space-y-6">
          {/* Paystack option */}
          <div className={`relative group rounded-[2.5rem] border-2 transition-all duration-500 cursor-pointer overflow-hidden ${paymentMethod === "paystack"
            ...
            <div className="p-8 sm:p-10 flex items-start gap-6">
              <div className="pt-1">
                ...
                <Label htmlFor="wallet" className="flex-1 cursor-pointer">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-6">
                    ...
                    <div className="px-4 py-2 bg-emerald-50 rounded-xl border border-emerald-100">
                      <span className="text-[10px] font-black text-emerald-700 tabular-nums">₦{walletBalance.toLocaleString()} AVAILABLE</span>
                    </div>
                  </div>
