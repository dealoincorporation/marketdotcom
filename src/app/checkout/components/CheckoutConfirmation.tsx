...
export function CheckoutConfirmation({
  ...
  return (
    <div className="max-w-4xl mx-auto py-4 sm:py-10">
      <div className="checkout-card bg-white/85 backdrop-blur-3xl rounded-[1.5rem] sm:rounded-[3rem] shadow-[0_48px_96px_-12px_rgba(0,0,0,0.15)] border border-white/70 overflow-hidden w-full transition-all duration-700">
        {/* Validation Header */}
        <div className="bg-emerald-950 p-6 sm:p-16 relative overflow-hidden text-center">
          ...
          <div className="relative z-10">
            <div className="w-16 h-16 sm:w-24 sm:h-24 bg-white/10 backdrop-blur-2xl rounded-[1rem] sm:rounded-[2rem] flex items-center justify-center mx-auto mb-5 sm:mb-8 border border-white/20 shadow-2xl group hover:scale-110 transition-transform duration-500">
              <Check className="h-8 w-8 sm:h-12 sm:w-12 text-emerald-400" />
            </div>
            <h1 className="text-[11px] sm:text-sm font-black text-white uppercase tracking-[0.22em] sm:tracking-[0.5em] mb-3 sm:mb-4">Order Confirmed</h1>
            <p className="text-emerald-400 text-[10px] sm:text-[11px] font-black uppercase tracking-[0.12em] sm:tracking-[0.2em] mb-2">
        ...
        <div className="p-4 sm:p-16">
          <div className="grid md:grid-cols-2 gap-4 sm:gap-10 mb-6 sm:mb-12">
            {/* Order summary */}
            <div className="bg-gray-50/50 rounded-[1.25rem] sm:rounded-[2.5rem] p-4 sm:p-10 border border-gray-100 flex flex-col group hover:bg-white hover:shadow-2xl transition-all duration-500">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
            <Button
              ...
              className="flex-[1.5] h-12 sm:h-14 bg-gray-900 hover:bg-gray-800 text-white rounded-xl sm:rounded-[1.5rem] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[10px] sm:text-[11px] shadow-2xl transition-all active:scale-[0.98] py-3 sm:py-8"
            >
              Track Order
            </Button>
            <Button
              ...
              variant="outline"
              className="flex-1 h-12 sm:h-14 border-2 border-gray-100 hover:border-gray-900 hover:bg-white rounded-xl sm:rounded-[1.5rem] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[9px] sm:text-[10px] text-gray-400 hover:text-gray-900 transition-all py-3 sm:py-8"
            >
          ...
          <div className="mt-8 sm:mt-12 flex justify-center">
            <div className="inline-flex items-center gap-4 sm:gap-8 py-3 sm:py-4 px-4 sm:px-8 bg-gray-50/50 rounded-2xl border border-gray-100">
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mt-6 sm:mt-8 px-4 sm:px-8 pb-6 sm:pb-8">
          <Button
            onClick={() => router.push('/dashboard?tab=orders')}
            className="flex-1 h-11 sm:h-12 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-semibold text-sm"
          >
            📊 View Orders
          </Button>
          <Button
            ...
            variant="outline"
            className="flex-1 h-11 sm:h-12 border-2 hover:bg-gray-50 font-semibold text-sm"
          >
            🛒 Continue Shopping
          </Button>
        </div>
