      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="md:hidden py-4 space-y-4">
          <div className="flex items-center justify-between">
            <Link href="/dashboard?tab=marketplace" className="group flex items-center space-x-2 px-3 py-2 rounded-lg hover:bg-gray-50 transition-all duration-200">
        ...
        <div className="hidden md:flex items-center justify-between h-20">
          <Link href="/dashboard?tab=marketplace" className="group flex items-center space-x-3 px-4 py-2 rounded-xl hover:bg-gray-50 transition-all duration-200">
