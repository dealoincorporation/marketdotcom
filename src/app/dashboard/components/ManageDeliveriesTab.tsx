          ...
          <form id="delivery-form" onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Select value={formData.timeSlot} onValueChange={(value) => setFormData(prev => ({ ...prev, timeSlot: value }))}>
                  ...
                  <SelectContent className="bg-white border border-gray-200 shadow-lg z-50">
                    <SelectItem value="9:00 AM - 12:00 PM" className="py-3 px-4 hover:bg-orange-50 focus:bg-orange-50">
                      9:00 AM - 12:00 PM
                    </SelectItem>
                    <SelectItem value="12:00 PM - 3:00 PM" className="py-3 px-4 hover:bg-orange-50 focus:bg-orange-50">
                      12:00 PM - 3:00 PM
                    </SelectItem>
                    <SelectItem value="3:00 PM - 6:00 PM" className="py-3 px-4 hover:bg-orange-50 focus:bg-orange-50">
                      3:00 PM - 6:00 PM
                    </SelectItem>
                    <SelectItem value="6:00 PM - 9:00 PM" className="py-3 px-4 hover:bg-orange-50 focus:bg-orange-50">
                      6:00 PM - 9:00 PM
                    </SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-xs text-gray-500">Choose the delivery time window</p>
              </div>
            </div>
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              <Button
                ...
                variant="outline"
                onClick={resetForm}
                className="px-6 py-2 h-11 text-base border-gray-300 hover:bg-gray-50"
              >
                Reset Form
              </Button>
              <Button
                type="submit"
                className="px-8 py-2 h-11 text-base bg-orange-600 hover:bg-orange-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-200"
              >
