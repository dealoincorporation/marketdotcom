...
export function WalletReferralSection({
  ...
  return (
    <div className="relative overflow-hidden glass-effect border border-white/60 rounded-[2rem] sm:rounded-[3rem] premium-shadow bg-white/40 backdrop-blur-3xl p-5 sm:p-10 lg:p-12">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center items-center text-center lg:text-left gap-6 lg:gap-8 mb-8 lg:mb-12">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-blue-500/10 rounded-[1.5rem] sm:rounded-[2rem] flex items-center justify-center shadow-inner border border-blue-500/20 shrink-0">
            <Users className="h-8 w-8 sm:h-10 sm:w-10 text-blue-600" />
          </div>
          <div>
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-gray-900 tracking-tight uppercase mb-3">Network Growth Program</h3>
            <p className="text-gray-500 font-bold max-w-3xl leading-relaxed text-base sm:text-lg">
        ...
        {!referralSettingsLoading && referralSettings.isActive && (
          <div className="mb-8 lg:mb-12 relative group">
            ...
            <div className="relative p-5 sm:p-8 lg:p-10 bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-3xl text-white shadow-2xl overflow-hidden">
              <div className="absolute top-0 right-0 p-8 opacity-10">
                <Gift className="h-32 w-32" />
              </div>
              <div className="relative z-10 flex flex-col lg:flex-row lg:items-center items-start justify-between gap-5 lg:gap-8">
                <div className="text-left">
                  <h4 className="text-xl sm:text-2xl lg:text-3xl font-black tracking-tight mb-2">
                    Earn {formatRefereeRewardForShare(referralSettings.referrerReward)} per referral
                  </h4>
                  <p className="text-gray-400 font-bold uppercase tracking-wide sm:tracking-widest text-[10px] sm:text-xs">
                    Friends receive {formatRefereeRewardForShare(referralSettings.refereeReward)} on their first acquisition
                  </p>
                </div>
                <div className="shrink-0">
                  <div className="bg-orange-600 px-4 sm:px-6 py-2.5 sm:py-3 rounded-2xl font-black uppercase tracking-wide sm:tracking-widest text-[11px] sm:text-sm shadow-xl shadow-orange-600/30">
                    Active Offer
                  </div>
                </div>
              </div>
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 lg:gap-6 mb-8 lg:mb-12">
          {[
            ...
            <div key={i} className="bg-white/40 border border-white/60 p-4 sm:p-5 lg:p-6 rounded-2xl sm:rounded-3xl text-center premium-shadow-sm group hover:bg-white/60 transition-all duration-300">
          ...
          <div className="col-span-2 md:col-span-1 border-2 border-dashed border-blue-500/30 p-4 sm:p-5 lg:p-6 rounded-2xl sm:rounded-3xl text-center group hover:border-blue-500/60 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] gap-6 lg:gap-8 items-stretch">
          <div className="bg-white/40 border border-white/60 p-5 sm:p-8 lg:p-10 rounded-[1.5rem] sm:rounded-[2.5rem] premium-shadow-sm">
          ...
          <div className="flex flex-col justify-center gap-4 sm:gap-6 lg:max-w-[420px] lg:ml-auto w-full">
            {referralSettings.isActive && (
              <>
                <button
                  onClick={onShareReferralCode}
                  className="group relative w-full h-14 sm:h-16 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black uppercase text-[10px] sm:text-xs tracking-[0.14em] sm:tracking-[0.2em] transition-all duration-300 shadow-xl shadow-blue-600/20 active:scale-95 flex items-center justify-center gap-3 overflow-hidden"
                >
                ...
                <button
                  ...
                  className="w-full h-14 sm:h-16 bg-white/60 hover:bg-white text-blue-600 rounded-2xl font-black uppercase text-[10px] sm:text-xs tracking-[0.14em] sm:tracking-[0.2em] transition-all duration-300 border border-blue-600/20 active:scale-95 flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
                >
