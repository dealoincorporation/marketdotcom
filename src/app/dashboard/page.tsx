...
function DashboardContent() {
  ...
  useEffect(() => {
    ...
    if (tabParam && ['marketplace', 'orders', 'wallet', 'admin', 'manage-products', 'manage-categories', 'manage-deliveries', 'manage-delivery-fees', 'manage-referrals', 'manage-points', 'notifications', 'admin-notifications'].includes(tabParam)) {
