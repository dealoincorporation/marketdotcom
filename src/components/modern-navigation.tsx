          ...
          <div className="flex justify-between items-center h-16 lg:h-20">
              ...
              {navItems.map((item, index) => (
                ...
                >
                  {item.external ? (
                    <Link
                      href={item.href}
                      className={`relative px-4 py-2 font-medium transition-colors group ${isScrolled ? 'text-gray-700 hover:text-orange-600' : 'text-gray-700 hover:text-orange-600'
                        }`}
                    >
                      {item.name}
                    ...
                    <button
                      ...
                      className={`relative px-4 py-2 font-medium transition-colors group cursor-pointer ${isScrolled ? 'text-gray-700 hover:text-orange-600' : 'text-gray-700 hover:text-orange-600'
                        }`}
                    >
                      {item.name}
                      <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-orange-600 group-hover:w-full transition-all duration-300"></span>
            ...
            <div className="hidden lg:flex items-center ml-4">
              <button
                ...
                className={`relative p-2 rounded-full transition-colors ${isScrolled ? 'text-gray-700 hover:text-orange-600 hover:bg-orange-50' : 'text-gray-700 hover:text-orange-600 hover:bg-orange-50'
                  }`}
              >
                <ShoppingBag className="h-6 w-6" />
                {totalItems > 0 && (
                  <span className="absolute top-0 right-0 h-4 w-4 bg-orange-600 text-white text-[10px] font-bold flex items-center justify-center rounded-full">
                    {totalItems}
                  </span>
                )}
              </button>
            ...
            <motion.button
              ...
              className={`lg:hidden p-2 rounded-lg transition-colors cursor-pointer ${isScrolled
