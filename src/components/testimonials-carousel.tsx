    ...
    <div className="relative max-w-4xl mx-auto">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-orange-100 overflow-hidden">
        ...
        <button
          ...
          className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 border border-orange-200"
        ...
        <button
          ...
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 border border-orange-200"
